...
const features = [
  { icon: Megaphone, text: "Accédez à des centaines de campagnes" },
  { icon: Wallet, text: "Paiements rapides via Mobile Money" },
...
const AuthCreator = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signup') {
        ...
        toast({
          title: 'Bienvenue !',
          description: 'Votre compte créateur a été créé avec succès.',
        });
        navigate('/campaigns');
      } else {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:flex-1 relative bg-gradient-to-br from-creator/10 via-creator/5 to-background overflow-hidden">
        {/* Background pattern */}
        <div className="absolute inset-0 bg-grid-pattern opacity-30" />
        
        {/* Floating shapes */}
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-creator/20 rounded-full blur-[100px] floating" />
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-info/10 rounded-full blur-[80px] floating" style={{ animationDelay: '2s' }} />
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-creator/15 flex items-center justify-center">
                  <feature.icon className="w-6 h-6 text-creator" />
                </div>
        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="mb-10">
            <Link to="/" className="inline-flex items-center gap-3 group">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-creator to-creator/80 flex items-center justify-center shadow-lg transition-transform group-hover:scale-105">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              {mode === 'signin' 
                ? 'Connectez-vous pour découvrir de nouvelles campagnes' 
                : 'Monétisez votre contenu avec les meilleures marques'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 h-12 rounded-xl border-border focus:border-creator focus:ring-creator/30"
            ...
            <Button 
              type="submit" 
              className="w-full h-12 rounded-xl text-base font-medium bg-creator hover:bg-creator/90"
              disabled={loading}
            >
              {loading ? (
          ...
          <div className="mt-6 text-center">
            ...
            >
              ...
              <span className="text-creator font-medium">
          ...
          <div className="mt-8 pt-8 border-t border-border">
            <Link to="/auth/seller" className="flex items-center justify-center gap-2 text-sm text-muted-foreground hover:text-seller transition-colors">
              <Store className="w-4 h-4" />
              <span>Vous êtes vendeur ? Connectez-vous ici</span>
            </Link>
          </div>
        </div>
      </div>
